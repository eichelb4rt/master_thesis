...
%     %                             & = \text{trace}(B \cdot A)
%     % \end{align*}
%     % where the second equality holds because of \cref{thm:nested_einsum:2},
...
%                                 & = \text{trace}(B \cdot A)
%     \end{align*}
%     where the second and fourth equality hold because of \cref{thm:nested_einsum:2},
...
% TODO: talk about how the theorems with duplications etc are enough to map all of linear algebra
